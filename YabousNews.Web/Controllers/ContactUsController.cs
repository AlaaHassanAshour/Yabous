...
namespace YabousNews.Web.Controllers
{
    public class ContactUsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,FName,LName,Email,Comment,Phonenamber")] ContactUs contactUs)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,FName,LName,Email,Comment,Phonenamber")] ContactUs contactUs)
        {
            if (id != contactUs.Id)
            {
                return NotFound();
